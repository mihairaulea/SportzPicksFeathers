package view.screens 
{
	...
	public class FacebookFriendsSelectScreen extends Screen
	{
		...
		public function FacebookFriendsSelectScreen() 
		{
		...
		override protected function initialize():void
		{
			...
			showAllButtonInactive.x = showAllButtonActive.x = 117;
			...
			showPlayingButtonInactive.x = showPlayingButtonActive.x = 215;
			...
			selectAllButton.isToggle = true;
			selectAllButton.isSelected = true;
			selectAllButton.defaultSkin = new Image( Assets.getAssetsTexture("select_all",2) );
			selectAllButton.defaultSelectedSkin  = new Image( Assets.getAssetsTexture("select_all_on", 2) );
			selectAllButton.labelFactory = getSelectText;
			selectAllButton.label = "Select All";
			selectAllButton.labelOffsetX = 2;
			addChild(selectAllButton);
			selectAllButton.x = 2;
			selectAllButton.y = 51;
		...
		private function getSelectText():TextFieldTextRenderer
		{
			var selectText:TextFieldTextRenderer = new TextFieldTextRenderer();
			selectText.width = 60;
			selectText.height = 21;
			selectText.textFormat = FontFactory.getTextFormat(1, 15, 0xFFFFFF);
		...
		{   			
			header = commonAssetsScreen.getHeader("Select Friends",true, headerBackButtonHandler, false);
			addChild( header );
