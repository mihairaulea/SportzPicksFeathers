package model 
{
	 ...
	 */
	 ...
	 public class DataRetrieval extends EventDispatcher 
	{
		
		public static var instance:DataRetrieval = null;
		...
		// VALUE OBJECTS
		public var lobbyInfo:LobbyInfoVA = new LobbyInfoVA();
		public var opponentInfo:OpponentInfoVA = new OpponentInfoVA();
		...
		private function setUpChecker():void
		{			
		...
		private function connectionErrorHandler(e:Event):void
		{
			...
			dispatchEvent(new Event(DataRetrieval.ERROR));
		}
		
		private function connectionOkHandler(e:Event):void
		{
			dispatchEvent(new Event(DataRetrieval.MODEL_SETUP_OK));
		}
		
		public static function getInstance():DataRetrieval
		{
			if (instance == null) instance = new DataRetrieval();
			return instance;
		}
						
		public function requestLobbyData(playerId:String):void
		{
		...
		private function lobbyDataLoaded(e:Event):void
		{
			...
			lobbyInfo.SecondsLeft = 0;//parsedObject.d.
			...
			dispatchEvent(new Event(DataRetrieval.LOBBY_DATA_RECEIVED));
		}
		...
		private function opponentListLoaded(e:Event):void
		{
			...
			dispatchEvent(new Event(DataRetrieval.OPPONENT_LIST_RECEIVED));
		...
		private function eventListLoaded(e:Event):void
		{
			trace(e.target.data);
		}
